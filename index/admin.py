...
from .models import Player, Game, Ship, GameShip, Map, Weapon, Shell, GameShell, MyImage, StaticObject, GameStaticObject, GameMoveableObject
...
admin.site.register(GameMoveableObject)
